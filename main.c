...
int main() {
    ...
    int sommet_initial, sommet_final; // sommet par lequel nous allons commencé notre parcours
    ...
    g = lire_graphe(nom_fichier,sommet_initial); // creation et affichage du graphe g1
